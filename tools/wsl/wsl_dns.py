...
def get_cisco_vpn_dns_servers():
  ...
  p = subprocess.run([PSCMD, '(Get-NetAdapter | Where-Object Status -Match "Up" | Where-Object InterfaceDescription -like "Cisco AnyConnect*" | Get-DnsClientServerAddress -AddressFamily IPv4).ServerAddresses | Sort-Object | Get-Unique | ConvertTo-Json -Compress'],
